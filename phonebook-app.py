...
# db_endpoint = open("/home/ec2-user/Phonebook-Application/dbserver.endpoint", 'r', encoding='UTF-8') 
...
app.config['MYSQL_DATABASE_HOST'] = 'database'  #db_endpoint.readline().strip()
...
def add_record():
    if request.method == 'POST':
        ...
        return render_template('add-update.html', show_result=True, result_html=result_app, not_valid=False, action_name='save', developer_name='Bekir') #In addition, There is no message shown by user here. Thats why not valid is going to be False.
    else:
...
def update_record():
    if request.method == 'POST':
        ...
        return render_template('add-update.html', show_result=True, result_html=result_app, not_valid=False, action_name='update', developer_name='Bekir') #Again, There is no message shown by user here. Thats why not valid is going to be False.
    else:
...
def delete_record():
    if request.method == 'POST':
        ...
        return render_template('delete.html', show_result=True, result_html=result_app, not_valid=False, developer_name='Bekir') # In addition, There will be no message to be shown to the user here. Thats why not valid is going to be False.
    else:
